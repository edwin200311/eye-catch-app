        ...
        <section className="mb-8 mt-4">
          <div className="flex justify-between items-end">
            <div>
              ...
              <h2 className="text-3xl font-extrabold font-headline tracking-tight text-on-surface dark:text-white">실시간 모니터링</h2>
            </div>
          </div>
        </section>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            >
              <img 
                ...
                src="https://images.unsplash.com/photo-1565626423194-55113d726615?auto=format&fit=crop&q=80" 
                alt="CCTV 썸네일" 
              />
              ...
              <div className="absolute inset-0 p-6 pointer-events-none flex flex-col justify-between">
                <div className="flex justify-end">
                  <div className="bg-black/50 backdrop-blur-md px-3 py-1 rounded-full flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-white">연결 대기중</span>
                  </div>
                </div>
                <div>
                  <h3 className="text-white font-bold text-xl drop-shadow-md">구역 1: 메인 게이트</h3>
                  <p className="text-slate-200 text-sm drop-shadow-md mt-1">터치하여 실시간 영상 접속</p>
                </div>
              </div>
            </div>
            ...
            <Link to="/incident-details" className="block bg-surface-container-lowest dark:bg-slate-800 p-5 rounded-xl shadow-sm space-y-4 hover:shadow-md transition-shadow duration-300">
              <div className="flex justify-between items-center">
                <h3 className="text-sm font-bold font-headline text-on-surface dark:text-white uppercase tracking-wider">최근 알림</h3>
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-surface-container-lowest dark:bg-slate-800 p-6 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 transition-colors duration-300">
              <h3 className="font-headline font-bold text-on-surface dark:text-white mb-4 flex items-center gap-2">
                <span className="material-symbols-outlined text-primary dark:text-blue-400">neurology</span> AI 인텔리전스 현황
              </h3>
